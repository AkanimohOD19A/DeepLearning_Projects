...
model = Model(inputs = mobile.input, outputs=predictions)#"Model" from keras functional[!Sequential] API

# Training only our Output layer
...
import os.path
path = '../PART_1/Models/FineTuneMobileNet_model.h5'
...
if os.path.isfile('../PART_1/Graphs/FineTuneMobileNet_graph.png') is False:
    plt.savefig('../PART_1/Graphs/FineTuneMobileNet_graph.png')
